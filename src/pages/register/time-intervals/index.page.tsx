    ...
    .transform((intervals) => {
      return intervals.map((interval) => {
        return {
          ...
          startTimeInMinute: convertTimeStringToMinutes(interval.startTime),
...
export default function TimeIntervals() {
  ...
  return (
    <>
      <NextSeo title="Selecione sua disponilidade | Andromeda Call" noindex />
      <Conatiner>
        <Header>
